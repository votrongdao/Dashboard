...
namespace DashboardSite.Model
{
    ...
    public class LocalPasswordModel
    {
        ...
        [Required]
        //[RegularExpression(@"^(?=.{8,})(?=.*[A-Z]).*$", ErrorMessage = "Password should be at least 8 characters and contains at least one upper case letter.")]
        ...
        public bool IsChangePasswordSuccess { get; set; }
    }
